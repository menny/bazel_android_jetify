    ...
    attrs = {
        ...
        "_jetifier_jars": attr.label_list(
            ...
            default = [
                ...
                Label("@com_android_tools_build_jetifier__jetifier_core__1_0_0_beta07//file"),
                Label("@com_android_tools_build_jetifier__jetifier_processor__1_0_0_beta07//file"),
                Label("@org_jetbrains_kotlin__kotlin_stdlib__1_3_41//file"),
                Label("@org_jetbrains_kotlin__kotlin_stdlib_common__1_3_41//file"),
            ],
            cfg = "host",
        ),
    },
